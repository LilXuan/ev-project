...
APP_NAME = "ACN_Dataset_Scaling_500MB"
...
OUTPUT_BASE_PATH = "hdfs://localhost:9000/data/benchmark/acn"
...
SCALING_METRICS_CSV = os.path.join(RESULT_DIR, "scaling_metrics.csv")
SCALING_VALIDATION_CSV = os.path.join(RESULT_DIR, "scaling_validation.csv")
# ========================================================
